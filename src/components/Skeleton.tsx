export function Skeleton() {
    return (
        <div className="glass-card p-10 animate-pulse border-violet-500/20 bg-slate-900/60">
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="h-24 bg-slate-950/50 rounded-2xl border border-slate-800"></div>
                <div className="h-24 bg-slate-950/50 rounded-2xl border border-slate-800"></div>
            </div>
        </div>
    );
